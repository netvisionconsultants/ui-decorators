...
describe('UIComponent', () => {
    ...
    it('UIComponent.renderComponent() adds multiple sections', () => {
        ...
        expect(json.components[2].title).toEqual('Section Two')
        ...
        expect(json2.components).toHaveLength(3)
        ...
        expect(json2.components[1].type).toEqual('section')
        expect(json2.components[1].title).toEqual('Section One')
        expect(json2.components[2].type).toEqual('section')
        expect(json2.components[2].title).toEqual('Section Two')
        expect(json2.components[2].components).toHaveLength(1)
    })
})
